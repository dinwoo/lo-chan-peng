...
mock.onPost("api/news/list").reply(() => {
  const response = {
    data: {
      news: [
        {
...
mock.onPost("api/news/detail").reply(() => {
  const response = {
    data: {
      id: 1,
      title: "唯一亞洲藝術家「羅展鵬」受邀與世界藝術大師共同展出",
...
mock.onGet("api/work/years").reply(() => {
  const response = {
...
mock.onPost("api/work/list").reply(() => {
  const response = {
    data: {
      works: [
        {
...
mock.onPost("api/course/detail").reply(() => {
  const response = {
    data: {
      id: 1,
      title: "【國際藝術家的油畫課｜從入門到經典三大技法】",
...
mock.onPost("api/member/signup").reply(() => {
  const response = {
    code: 200,
    msg: ""
  }
...
mock.onPost("api/member/validation").reply(() => {
  const response = {
    code: 200,
    msg: ""
  }
...
mock.onPost("api/member/info").reply(() => {
  const response = {
    data: {
      name: "Daniel",
      birthday: "2000-01-01",
...
mock.onPut("api/member/edit").reply(() => {
  const response = {
    code: 200,
    msg: ""
  }
...
mock.onPost("api/member/signin").reply(() => {
  const response = {
    data: {
      status: 1,
      name: "Daniel",
